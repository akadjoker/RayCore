...
function demo.load()
    ...
    bodyImage = core.graphics.newImage("assets/images/carro.png")
    rodaImage = core.graphics.newImage("assets/images/roda.png")
    ...
    local py =32
     ...
     wheel1 = core.physics.newBody(0,x-50,y+py)
    local sp1 = wheel1:addCircle(10)
    sp1:setFriction(1.2)
    sp1:setDensity(0.8)

     wheel2 = core.physics.newBody(0,x+60,y+py)
    ...
    local axisY=1.0
      ...
      joint1 = core.physics.newWheelJoint(car,wheel1,x-50,y+py,axisX,axisY)
      joint2 = core.physics.newWheelJoint(car,wheel2,x+60,y+py,axisX,axisY)
...
function demo.draw()
    ...
    core.graphics.draw(bodyImage,x,y, angle, 1.0,1.0, w,h, 0,0)
    core.graphics.draw(rodaImage,roda1_x,roda1_y, roda1_angle, 1.0,1.0, rw,rh, 0,0)
    core.graphics.draw(rodaImage,roda2_x,roda2_y, roda2_angle, 1.0,1.0, rw,rh, 0,0)
